...
/*
    ...
    STATIC: I want to use the value of a variable in one class in another class
    at runtime. I also want to access the variable without creating an object of
    its class. Help me implement this
    ...
    Print out the value of Class A and class B in your main method using the object
    of only One class. (Dont create two objects).
...
//I will look at the task on my gmail for submission and file structure for this task